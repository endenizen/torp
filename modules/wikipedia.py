#!/usr/bin/env python
"""
wikipedia.py - Torp Wikipedia Module
...
def wik(torp, input): 
   ...
   if not origterm: 
      return torp.say('Perhaps you meant ".wik Zen"?')
   ...
   try: result = wikipedia(term)
      ...
      return torp.say(error)

   if result is not None: 
      torp.say(result)
   else: torp.say('Can\'t find anything in Wikipedia for "%s".' % origterm)
